...
bool HeroChoose::init()
{
	...
	//切换界面背景
	auto ChooseBackGround = Sprite::create("UI/ChooseBackGround.png");
	ChooseBackGround->setPosition(Vec2(origin.x + visibleSize.width / 2, origin.y + visibleSize.height / 2));
	ChooseBackGround->setScaleX(1.55f);
	ChooseBackGround->setScaleY(1.8f);
	...
	labelChoose->setColor(ccc3(0, 0, 0));
	...
	auto pBackButtonItem = MenuItemImage::create("UI/Exitbutton.jpg", "UI/ExitbuttonP.jpg", CC_CALLBACK_1(HeroChoose::EnterHelloWorldScene, this));
	...
	//人物头像1
	auto pHero_1Avatar = MenuItemImage::create("Hero1_Avatar.png", "Hero1_AvatarP.png", CC_CALLBACK_1(HeroChoose::OnRoleSelect1, this));
	...
	//人物头像2
	auto pHero_2Avatar = MenuItemImage::create("Hero2_Avatar.png", "Hero2_AvatarP.png", CC_CALLBACK_1(HeroChoose::OnRoleSelect2, this));
	...
	//人物头像3
	auto pHero_3Avatar = MenuItemImage::create("Hero3_Avatar.png", "Hero3_AvatarP.png", CC_CALLBACK_1(HeroChoose::OnRoleSelect3, this));
